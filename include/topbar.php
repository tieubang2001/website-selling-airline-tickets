	...
	if(isset($_POST['dangnhap_home'])) {
		...
		if($taikhoan=='' || $matkhau ==''){
			...
			if($count>0){
				...
				header('Location: index.php?quanly=bookve');
			}else{
...
<!-- top-header -->
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemve&khachhang=<?php echo $_SESSION['khachhang_id'] ?>" class="text-white">
								<i class="fas fa-truck mr-2"></i>Xem Vé : <?php echo $_SESSION['dangnhap_home'] ?></a>
						</li>
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=bookve&dangxuat=1" class="text-white">
						...
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0778268330
						</li>
						<li class="text-center border-right text-white">
				...
				<div class="modal-body">
					<form id="formDangKy" action="" method="post">
						...
						<div class="form-group">
							...
							<input id="cccd" type="text" class="form-control" placeholder="" name="cccd">
							<div class="invalid-feedback"></div>
						</div>
						<div class="form-group">
							<label class="col-form-label">Email</label>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo6.jpg" alt=" " class="img-fluid">AirLine
						</a>
					</h1>
				</div>
				<!-- //logo -->
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="POST">
								<input class="form-control mr-sm-2" name="search_product" type="search" placeholder="Tìm Kiếm Chuyến Bay" aria-label="Search" >
								<input class="form-control mr-sm-2" name="search_date" type="date" value="<?php if(isset($_POST['search_date'])) echo $_POST['search_date'];?>" placeholder="Ngày đi" aria-label="Search">
						...
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								<form action="index.php?quanly=bookve" method="post" class="last">
	...
	<script>
			$('#formDangKy').on('submit', function(e) {
				...
				if (!cccd) {
					errors.cccd = 'Cột CCCD không được bỏ trống';
					hasError = true;
